...
<!-- ============================================================= -->            
            ...
            <div class="card card-info">
                ...
                <div class="card-footer">  
                  <a href="#" class="btn btn-warning"><i class="far fa-user nav-icon"></i>&nbsp;Add Teacher</a>
                </div>
          ...
          <div class="col-12">
            ...
            <div class="card card-purple">
              <div class="card-header">
                <h3 class="card-title">Teachers Detail</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped nowrap">
                  ...
                  <?php
                    $mobno = $_SESSION['login'];
                    $sln=1;
                    $sql = "SELECT a.*, b.fullname,b.mobno,b.registeras FROM tbl_teachers a, tbl_registration1 b  where a.pid=b.id";
                    $query = $conn->query($sql);
                    while($row = $query->fetch_assoc()){                    
                      ...
                      echo"<tr>
                          ...
                          <td>
                          <a href='approved_registration.php?id=".$row['pid']."&as=Teacher' class='btn btn-success'><i class='fas fa-check nav-icon'></i></a>
                ...
                <?php include "include/teachers_detail_modal.php";?>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
